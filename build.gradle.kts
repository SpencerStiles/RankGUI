...
// Configure server testing - using local Hytale server
runHytale {
    // Use the actual Hytale server from the game installation
    jarUrl = "file:///C:/Users/Spencer/AppData/Roaming/Hytale/install/release/package/game/latest/Server/HytaleServer.jar"
}
